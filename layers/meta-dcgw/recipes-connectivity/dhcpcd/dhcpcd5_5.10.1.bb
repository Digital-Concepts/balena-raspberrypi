...
do_install() {
    ...
    install -m 0644 ${S}/etc/dhcpcd.conf ${D}${sysconfdir}/dhcpcd.conf
    ...
    install -m 0644 ${S}/usr/share/man/man5/dhcpcd.conf.5.gz ${D}${mandir}/man5/
    install -d ${D}${mandir}/man8
    install -m 0644 ${S}/usr/share/man/man8/dhcpcd*.8.gz ${D}${mandir}/man8/
